const quizData = [
  ...
  },
  {
    ...
    a: "En type nettverksprotokoll",
    b: "Et krypteringsverktøy for sikker kommunikasjon",
    c: "En unik identifikator for hver maskin som kobles til Internett",
    d: "Et verktøy for å identifisere domeneeiere",
    correct: "c",
  },
  {
    question: "Hva er en DNS-server?",
    a: "En enhet som lagrer sikkerhetssertifikater for HTTPS",
    b: "En tjeneste som oversetter domenenavn til IP-adresser",
    c: "En server som håndterer filoverføringer mellom klienter",
    d: "En server som krypterer nettverkstrafikk",
    correct: "b",
  },
  {
    question: "Hva er en nettleser?",
    a: "En applikasjon for å sende e-post",
    b: "Et program som brukes til å hente og vise websider fra servere",
    c: "En enhet som lagrer nettsider",
    d: "En sikkerhetsprotokoll for nettkommunikasjon",
    correct: "b",
  },
  {
    question: "Hva er forskjellen mellom GET og POST i HTTP?",
    a: "GET brukes kun til å laste ned filer",
    b: "GET brukes til å hente data fra serveren, mens POST brukes til å sende data til serveren",
    c: "GET er sikrere enn POST",
    d: "POST brukes kun i kryptert kommunikasjon",
    correct: "b",
  },
  {
    question: "Hva er en HTTP-statuskode 404?",
    a: "Tilkoblingen er kryptert",
    b: "Forespørselen krever autentisering",
    c: "Serveren er overbelastet",
    d: "Siden ble ikke funnet",
    correct: "d",
  },
  {
    question: "Hva brukes TLS til?",
    a: "Å optimalisere hastigheten på nettsider",
    b: "Å oversette domenenavn til IP-adresser",
    c: "Å sikre kommunikasjon over Internett ved hjelp av kryptering",
    d: "Å redusere størrelsen på nettverkspakker",
    correct: "c",
  },
  {
  ...
  },
  {
    ...
    b: "En adresse for multicast-kommunikasjon",
    c: "Et tall som identifiserer en spesifikk rute",
    d: "En kode for å kryptere data",
    correct: "a",
  },
  {
